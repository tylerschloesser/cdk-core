...
- Read `CLAUDE.md` and the rule files in `.claude/rules/` whose `paths` cover the changed
  files. A passing check that violates an invariant named there is a FAIL, and you cite the
  rule.
